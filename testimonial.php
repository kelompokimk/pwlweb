...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO testimonial (name, email, profession, testimonial) VALUES ('$name', '$email', '$profession', '$testimonial')";
    
    if(mysqli_query($koneksi, $sql)){
        // Redirect to testimonial page after successful submission
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal mb-5">Add Your Testimonial</h5>
                </div>
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave your testimonial" id="testimonial" name="testimonial" style="height: 150px"></textarea>
